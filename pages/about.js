      ...
      <main className="max-w-7xl mx-auto p-4 flex flex-col md:flex-row gap-4 bg-white">
        <section className="flex-1">
          ...
          <p className="text-gray-600 mb-4 text-lg">
            Red, White and True News is dedicated to providing accurate, unbiased news and commentary that reflects
            traditional American values. Our mission is to cut through the noise of mainstream media and deliver the
            truth to patriotic Americans who deserve better.
          </p>
          <h2 className="text-2xl font-bold text-[#3C3B6E] mb-3">Our Mission</h2>
          <p className="text-gray-600 mb-4 text-lg">
            We believe in the principles that made America great: freedom, liberty, and the pursuit of truth. Our team
            of dedicated journalists and commentators work tirelessly to bring you news that matters, without the
            liberal bias that plagues so much of today's media landscape.
          </p>
          ...
          <ul className="text-gray-600 mb-4 text-lg list-disc list-inside space-y-2">
            <li>
              <strong>Truth in Journalism:</strong> We fact-check our stories and provide sources for our claims
            </li>
            <li>
              <strong>Constitutional Values:</strong> We support the Constitution and Bill of Rights
            </li>
            <li>
              <strong>Traditional Values:</strong> We believe in family, faith, and community
            </li>
            <li>
              <strong>Economic Freedom:</strong> We support free market capitalism and limited government
            </li>
            <li>
              <strong>National Security:</strong> We believe in a strong defense and secure borders
            </li>
          </ul>
          ...
          <p className="text-gray-600 mb-4 text-lg">
            Have a story tip or want to get in touch? Email us at{" "}
            <a
